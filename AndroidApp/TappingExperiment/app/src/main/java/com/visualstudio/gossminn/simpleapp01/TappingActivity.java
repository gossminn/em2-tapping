...
// Activity where the experiment actually takes place
// Reads stimuli from Assets file, shows stimuli, records input in file

    // Declare trial iterator and current trial object
    static Iterator<Trial> trialIterator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Import stimuli
        try {
            InputStream file = getAssets().open("trials.csv");
        ...
        trialIterator = trialList.getTrials().iterator();
        ...
        try {
            ...
            String fileName = dateStamp + "_trial" + ".csv";
